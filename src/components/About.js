      ...
      <div className="container">
        <div className="row">
          <div className="w-6/12 p-[25px]">
            <h3 className="text-3xl font-bold leading-10 text-[ rgba(37, 37, 37, 0.733)]">درباره ما</h3>
            <h3 className="text-gray-900 leading-10 mb-4 text-3xl font-bold">به رستوران رشیدی خوش آمدید</h3>
